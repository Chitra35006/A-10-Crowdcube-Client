      ...
      <div className="container mx-auto px-6 py-10">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-2xl font-bold"><span className="text-rose-200">Crowd</span><span className="text-blue-300">Cube</span></h1>
          ...
          <fieldset className="form-control w-full md:w-80">
            ...
            <div className="join flex flex-col md:flex-row">
              ...
              />
              <button className="btn bg-gradient-to-r from-rose-300 to-violet-400 text-indigo-900 hover:text-rose-500 join-item">Subscribe</button>
            </div>
          </fieldset>
        </form>
