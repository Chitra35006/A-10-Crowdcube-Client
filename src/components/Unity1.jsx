...
const Unity1 = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-12 gap-8  mt-10">
          {/* Item 1 */}
          <div className={`flex flex-col items-center justify-center col-span-4 border-l-4 rounded-md  p-4 ${theme === "light" ? "bg-blue-200" : "bg-blue-950"} ${theme === "light" ? "border-violet-400 " : "border-blue-400 "}`}>
          ...
          {/* Item 2 */}
          <div className={`flex flex-col items-center justify-center col-span-4 border-l-4 rounded-md  p-4 ${theme === "light" ? "bg-yellow-200" : "bg-yellow-800"} ${theme === "light" ? "border-violet-400 " : "border-yellow-400 "}`}>
          ...
          {/* Item 3 */}
          <div className={`flex flex-col items-center justify-center col-span-4 border-l-4 rounded-md  p-4 ${theme === "light" ? "bg-green-200" : "bg-green-900"} ${theme === "light" ? "border-violet-400 " : "border-green-400 "}`}>
          ...
          {/* Item 4 */}
          <div className={`flex flex-col items-center justify-center col-span-4 border-l-4 rounded-md  p-4 ${theme === "light" ? "bg-violet-200" : "bg-violet-950"} ${theme === "light" ? "border-violet-400 " : "border-violet-400 "}`}>
          ...
          {/* Item 5 */}
          <div className={`flex flex-col items-center justify-center col-span-4 border-l-4 rounded-md  p-4 ${theme === "light" ? "bg-pink-200" : "bg-pink-900"} ${theme === "light" ? "border-violet-400 " : "border-pink-400 "}`}>
          ...
          {/* Item 6 */}
          <div className={`flex flex-col items-center justify-center col-span-4 border-l-4 rounded-md  p-4 ${theme === "light" ? "bg-orange-200" : "bg-orange-900"} ${theme === "light" ? "border-violet-400 " : "border-orange-400 "}`}>
